...
$total_user     = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*) as t FROM user WHERE role='user'"))['t'];
$total_admin    = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*) as t FROM user WHERE role IN ('super_admin', 'admin_user', 'admin_antrean')"))['t'];
$total_antrean  = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*) as t FROM antrian"))['t'];
$antrean_hari   = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*) as t FROM antrian WHERE tanggal_kunjungan=CURDATE()"))['t'];
    ...
    <div class="main-content">
        <div class="navbar">
            <div class="nav-user">
                ...
                <span><?= htmlspecialchars($_SESSION['nama']) ?> (<?= ucfirst(str_replace('_', ' ', $_SESSION['role'])) ?>)</span>
            </div>
